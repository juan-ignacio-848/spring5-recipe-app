...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    @Transactional // Each time we are going in and out spring data JPA repositories, we are going out of a hibernate transaction. The lazy collections need
                   // to get initilized within a transaction and within the same hibernate session. The problem is we are getting LazyInitializationException
                   // because we are getting it outside of that.
